...
\hypersetup{
    ...
    filecolor=magenta,      
    urlcolor=cyan,
    pdftitle={Advanced Systems Programming Summary},
...
\begin{document}
\title{Exam Preparation and Summary of Topics\\Advances Systems Programming S. 5 Bachelor WS21/22\\h\_da Darmstadt}
\author{Jonas Weßner}
\maketitle
\tableofcontents
